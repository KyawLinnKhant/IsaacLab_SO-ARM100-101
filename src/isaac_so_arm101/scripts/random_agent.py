...
def main():
    """Random joint_actions agent with Isaac Lab environment."""
    ...
    while omni_app.is_running():
        ...
        with torch.inference_mode():
            # sample joint_actions from -1 to 1
            joint_actions = 2 * torch.rand(env.action_space.shape, device=env.unwrapped.device) - 1
            # apply joint_actions
