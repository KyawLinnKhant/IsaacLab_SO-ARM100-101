...
from isaac_so_arm101.tasks.lift.lift_env_cfg import CubeLiftEnvCfg

from isaaclab.markers.config import FRAME_MARKER_CFG  # isort: skip


@configclass
class Arm100LiftCubeEnvCfg(CubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.joint_actions.gripper_action = mdp.BinaryJointPositionActionCfg(
            asset_name="robot",
            joint_names=["gripper"],
        ...
        viz_marker_cfg = FRAME_MARKER_CFG.copy()
        viz_marker_cfg.markers["frame"].scale = (0.05, 0.05, 0.05)
        viz_marker_cfg.prim_path = "/Visuals/FrameTransformer"
        self.scene.ee_frame = FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/Robot/base",
            debug_vis=True,
            visualizer_cfg=viz_marker_cfg,
            target_frames=[
...
@configclass
class Arm100LiftCubePlayEnvCfg(Arm100LiftCubeEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class Arm101LiftCubeEnvCfg(CubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class Arm101LiftCubePlayEnvCfg(Arm101LiftCubeEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        # make a smaller scene for play
